...
class TestComponentReplacement(parameterized.TestCase):
    ...
    def test_replace_component_success(self,
        ...
        source = '''
            Poco::Fruit::Component<int> getReplacedComponent(ReplacedComponentParamTypes) {
              static int n = 10;
              return Poco::Fruit::createComponent()
                  .bindInstance(n);
            }
            
            Poco::Fruit::Component<int> getReplacementComponent(ReplacementComponentParamTypes) {
              static int n = 20;
              return Poco::Fruit::createComponent()
                  .bindInstance(n);
            }
            
            Poco::Fruit::Component<int> getRootComponent() {
              return Poco::Fruit::createComponent()
            ...
            int main() {
              Poco::Fruit::Injector<int> injector(getRootComponent);
    ...
    def test_replace_component_success_across_normalized_component(self,
        ...
        source = '''
            ...
            Poco::Fruit::Component<> getRootComponent1() {
              return Poco::Fruit::createComponent()
                  .replace(ReplacedComponentInstallation).with(ReplacementComponentInstallation);
            }
            
            Poco::Fruit::Component<int> getRootComponent2() {
              return Poco::Fruit::createComponent()
                  .install(ReplacedComponentInstallation);
            }
            
            int main() {
              Poco::Fruit::NormalizedComponent<> normalizedComponent(getRootComponent1);
              Poco::Fruit::Injector<int> injector(normalizedComponent, getRootComponent2);
              int n = injector.get<int>();
              Assert(n == 20);
            }
            '''
    ...
    def test_replace_component_installed_using_component_function_success(self,
        ...
        source = '''
            ...
            Poco::Fruit::Component<int> getRootComponent() {
              return Poco::Fruit::createComponent()
                  .replace(ReplacedComponentInstallation).with(ReplacementComponentInstallation)
                  .installComponentFunctions(Poco::Fruit::componentFunction(ReplacedComponentInstallation));
            }
    ...
    def test_replace_component_success_with_conversion(self):
        source = '''
            Poco::Fruit::Component<int> getReplacedComponent(std::string) {
              static int n = 10;
              return Poco::Fruit::createComponent()
                  .bindInstance(n);
            }
            
            Poco::Fruit::Component<int> getReplacementComponent(double, std::string, int) {
              static int n = 20;
              return Poco::Fruit::createComponent()
                  .bindInstance(n);
            }
    ...
    def test_replace_component_installed_using_component_function_success_with_conversion(self):
        source = '''
            ...
            Poco::Fruit::Component<int> getRootComponent() {
              return Poco::Fruit::createComponent()
                  .replace(getReplacedComponent, "Hi").with(getReplacementComponent, 2.0, "Hello", 12)
                  .installComponentFunctions(Poco::Fruit::componentFunction(getReplacedComponent, "Hi"));
            }
    ...
    def test_replace_component_chain_success(self,
        ...
        source = '''
            Poco::Fruit::Component<int> getReplacedComponent(ComponentParamTypes) {
              static int n = 10;
              return Poco::Fruit::createComponent()
                  .bindInstance(n);
            }
            
            Poco::Fruit::Component<int> getReplacementComponent(ComponentParamTypes) {
              static int n = 20;
              return Poco::Fruit::createComponent()
                  .bindInstance(n);
            }
            
            Poco::Fruit::Component<int> getReplacementReplacementComponent(ComponentParamTypes) {
              static int n = 30;
              return Poco::Fruit::createComponent()
                  .bindInstance(n);
            }
    ...
    def test_replace_component_different_type_error(self):
        source = '''
            Poco::Fruit::Component<int> getReplacedComponent();
            Poco::Fruit::Component<double> getReplacementComponent();
        ...
        expect_generic_compile_error(
            ...
            # MSVC
            r'|could not deduce template argument for .Poco::Fruit::Component<int> \(__cdecl \*\)\(FormalArgs...\). from .Poco::Fruit::Component<double> \(void\).',
            COMMON_DEFINITIONS,
            source)
    ...
    def test_replace_component_already_replaced_inconsistent_error(self,
        ...
        source = '''
            ...
            Poco::Fruit::Component<int> getOtherReplacementComponent(ReplacementComponentParamTypes) {
              static int n = 30;
              return Poco::Fruit::createComponent()
                  .bindInstance(n);
            }
        ...
        expect_runtime_error(
            ...
            r'(class )?Poco::Fruit::Component<int> \((__cdecl)?\*\)\((void)?ReplacedComponentParamTypes\) was replaced '
            r'\(using .replace\(...\).with\(...\)\) with both the component function at (0x)?[0-9a-fA-F]* with signature '
            r'(class )?Poco::Fruit::Component<int> \((__cdecl)?\*\)\(.*\) and the component function at '
            r'(0x)?[0-9a-fA-F]* with signature (class )?Poco::Fruit::Component<int> \((__cdecl)?\*\)\(.*\) .',
            COMMON_DEFINITIONS,
            source,
            locals())
    ...
    def test_replace_component_after_install_error(self,
        ...
        expect_runtime_error(
            ...
            r'(0x)?[0-9a-fA-F]* with signature (class )?Poco::Fruit::Component<int> \((__cdecl)?\*\)\((void)?ReplacedComponentParamTypes\) with the '
            r'component function at (0x)?[0-9a-fA-F]* with signature '
            r'(class )?Poco::Fruit::Component<int> \((__cdecl)?\*\)\(.*\) because the former component function '
    ...
    def test_replace_component_after_install_across_normalized_component_error(self,
        ...
        source = '''
            ...
            Poco::Fruit::Component<int> getRootComponent1() {
              return Poco::Fruit::createComponent()
                  .install(ReplacedComponentInstallation);
            }
            ...
            int main() {
              Poco::Fruit::NormalizedComponent<int> normalizedComponent(getRootComponent1);
              Poco::Fruit::Injector<int> injector(normalizedComponent, getRootComponent2);
              (void) injector;
            }
            '''
    ...
    def test_replace_component_unused_ok(self,
            ReplacedComponentParamTypes, ReplacedComponentInstallation, ReplacementComponentParamTypes, ReplacementComponentInstallation):
        source = '''
            Poco::Fruit::Component<> getReplacedComponent(ReplacedComponentParamTypes) {
              static int n = 10;
              return Poco::Fruit::createComponent()
                  .addInstanceMultibinding(n);
            }
            
            Poco::Fruit::Component<> getReplacementComponent(ReplacementComponentParamTypes) {
              static int n = 20;
              return Poco::Fruit::createComponent()
                  .addInstanceMultibinding(n);
            }
    ...
    def test_replace_multiple_components_with_same(self,
        ...
        source = '''
            ...
            Poco::Fruit::Component<> getOtherReplacementComponent(ReplacedComponentParamTypes) {
              static int n = 20;
              return Poco::Fruit::createComponent()
                  .addInstanceMultibinding(n);
            }
    ...
    def test_replace_component_one_set_of_args_only(self):
        source = '''
            Poco::Fruit::Component<> getReplacedComponent(double) {
              static int n = 10;
              return Poco::Fruit::createComponent()
                  .addInstanceMultibinding(n);
            }
            
            Poco::Fruit::Component<> getReplacementComponent() {
              static int n = 20;
              return Poco::Fruit::createComponent()
                  .addInstanceMultibinding(n);
            }
    ...
    def test_replace_component_already_replaced_with_different_args(self):
        source = '''
            ...
            Poco::Fruit::Component<> getOtherReplacementComponent() {
              static int n = 30;
              return Poco::Fruit::createComponent()
                  .addInstanceMultibinding(n);
            }
