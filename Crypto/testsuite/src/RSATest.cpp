...
RSATest::RSATest(const std::string& name): Poco::CppUnit::TestCase(name)
{
}
...
Poco::CppUnit::Test* RSATest::suite()
{
	Poco::CppUnit::TestSuite* pSuite = new Poco::CppUnit::TestSuite("RSATest");
