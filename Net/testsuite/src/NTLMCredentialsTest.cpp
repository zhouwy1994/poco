...
NTLMCredentialsTest::NTLMCredentialsTest(const std::string& name): Poco::CppUnit::TestCase(name)
{
}
...
Poco::CppUnit::Test* NTLMCredentialsTest::suite()
{
	Poco::CppUnit::TestSuite* pSuite = new Poco::CppUnit::TestSuite("NTLMCredentialsTest");
