...
NetworkInterfaceTest::NetworkInterfaceTest(const std::string& name): Poco::CppUnit::TestCase(name)
{
}
...
Poco::CppUnit::Test* NetworkInterfaceTest::suite()
{
	Poco::CppUnit::TestSuite* pSuite = new Poco::CppUnit::TestSuite("NetworkInterfaceTest");
