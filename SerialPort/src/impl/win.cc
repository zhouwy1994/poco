...
#include "Poco/SerialPort/impl/win.h"

using std::string;
using std::wstring;
using std::stringstream;
using std::invalid_argument;
using Poco::SerialPort::Serial;
using Poco::SerialPort::Timeout;
using Poco::SerialPort::bytesize_t;
using Poco::SerialPort::parity_t;
using Poco::SerialPort::stopbits_t;
using Poco::SerialPort::flowcontrol_t;
using Poco::SerialPort::SerialException;
using Poco::SerialPort::PortNotOpenedException;
using Poco::SerialPort::IOException;
...
Serial::SerialImpl::open ()
{
  ...
  // See: https://github.com/wjwwood/Poco/SerialPort/issues/84
...
void
Serial::SerialImpl::setTimeout (Poco::SerialPort::Timeout &timeout)
{
  timeout_ = timeout;
  if (is_open_) {
    reconfigurePort ();
...
void
Serial::SerialImpl::setBytesize (Poco::SerialPort::bytesize_t bytesize)
{
  bytesize_ = bytesize;
  if (is_open_) {
    reconfigurePort ();
...
void
Serial::SerialImpl::setParity (Poco::SerialPort::parity_t parity)
{
  parity_ = parity;
  if (is_open_) {
    reconfigurePort ();
...
void
Serial::SerialImpl::setStopbits (Poco::SerialPort::stopbits_t stopbits)
{
  stopbits_ = stopbits;
  if (is_open_) {
    reconfigurePort ();
