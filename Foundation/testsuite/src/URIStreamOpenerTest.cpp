...
URIStreamOpenerTest::URIStreamOpenerTest(const std::string& name): Poco::CppUnit::TestCase(name)
{
}
...
Poco::CppUnit::Test* URIStreamOpenerTest::suite()
{
	Poco::CppUnit::TestSuite* pSuite = new Poco::CppUnit::TestSuite("URIStreamOpenerTest");
