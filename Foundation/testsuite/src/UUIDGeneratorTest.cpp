...
UUIDGeneratorTest::UUIDGeneratorTest(const std::string& name): Poco::CppUnit::TestCase(name)
{
}
...
Poco::CppUnit::Test* UUIDGeneratorTest::suite()
{
	Poco::CppUnit::TestSuite* pSuite = new Poco::CppUnit::TestSuite("UUIDGeneratorTest");
